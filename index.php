								...
								<td class="d-lg-table-cell">
									...
									<?php if (!empty($show_month)) { //當月份不是空值
										if (empty($_SESSION["name"])) { //有月份，沒名字
											echo '查詢【<span class="clr">' . $show_month . '月</span>】的結果';
										} else {
											echo '查詢【<span class="clr">' . $show_month . '月</span>】【<span class="clr">' . $_SESSION["name"] . '</span>】的結果';
										}
									} elseif (!empty($_SESSION["name"])) { //僅有查詢名字的顯示
										echo '查詢【<span class="clr">' . $_SESSION["name"] . '</span>】的結果';
									} else {
										echo '<span class="clr">尚未選擇查詢條件！</span>';
									}
									?>
								</td>
							</tr>
							<tr class="col-lg-12 row">
								<td class="col-lg-3 col-md-12 col-sm-12 mt-md-3 mt-sm-3">
									<label for="month" class="d-none d-lg-inline-flex">月份：</label>
								...
								<td class="col-lg-4 col-md-12 col-sm-12 mt-md-3 mt-sm-3">
									<label for="area" class="d-none d-lg-inline-flex">地區：</label>
								...
								<td class="col-lg-4 col-md-12 col-sm-12 mt-md-3 mt-sm-3">
									<label for="name" class="d-none d-lg-inline-flex">委員：</label>
									<select name="name" id="name">
										<option disabled selected value="">請先選取地區</option>
									</select>
								</td>
								<td class="col-lg-1 col-md-12 col-sm-12 mt-md-3 mt-sm-3 searchbtn d-lg-table">
					...
					<table class="table content">
						<thead>
							...
							<tr>
								...
								<th class="d-none d-lg-table-cell">助理</th>
							...
							<?php while ($stmt_limit->fetch()) { ?>
								<tr>
									...
									<td class="d-lg-table-cell">
										...
										<a href="https://www.google.com/maps/dir/?api=1&origin=<?php echo $comaaddr; ?>&waypoints=台中市東區仁和路482號&destination=<?php echo $obaddc; ?>&travelmode=driving" target="_blank">[經所]
										</a>
									...
									<?php if (!empty($obcount)) { //若有輔導次數 ?>
										<td class="d-lg-table-cell">
											...
											<a href="https://www.google.com/maps/dir/?api=1&origin=<?php echo $combaddr; ?>&waypoints=台中市東區仁和路482號&destination=<?php echo $obaddc; ?>&travelmode=driving" target="_blank">[經所]
											</a>
